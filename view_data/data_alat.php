	...
	echo"	<div class='col-md-12'>
		...
		echo"<tr>
				...
				<td class='td-actions text-center'>";
					if($xhimg==''){
						echo"<a href='hapusalat-$xid&g=$xnone' class='btn btn-danger btn-sm'>
							<button type='button' rel='tooltip' title='Remove' class='btn btn-white btn-link btn-sm'>
							<i class='material-icons'>close</i>
							</button>
						</a> ";
					}else{
						echo"<a href='hapusalat-$xid&g=$xhimg' class='btn btn-danger btn-sm'>
							<button type='button' rel='tooltip' title='Remove' class='btn btn-white btn-link btn-sm'>
							<i class='material-icons'>close</i>
							</button>
						</a> ";
					}
					echo"<a href='editalat-$xid' class='btn btn-info btn-sm'>

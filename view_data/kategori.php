<?php
	...
	<div class='card'>
		<div class='card-body'>
			...
			<tr>
				<td><a class='btn btn-success btn-sm' href='tambahkategori'>Tambah Data Kategori</a><td>
	...
	echo"<div class='col-md-12'>
		...
		echo"<tr>
				...
				<td class='td-actions text-center'>
					<a class='btn btn-danger btn-sm' href='hapuskat-$xidk'>
						<button type='button' rel='tooltip' title='Remove' class='btn btn-white btn-link btn-sm'>
							<i class='material-icons'>close</i>
						</button>
					</a>
					
					<a class='btn btn-primary btn-sm' href='editkat-$xidk'>
